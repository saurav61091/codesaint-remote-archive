...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("About RustDesk", "About SaintDesk"),
        ("Keep RustDesk background service", "Keep SaintDesk running in the background"),
        ("desk_tip", "Your desktop can be accessed with this ID and password."),
        ("connecting_status", "Connecting to the SaintDesk network..."),
        ...
        ("Slogan_tip", "Secure remote support by Codesaint Technologies"),
        ...
        ("install_tip", "Due to UAC, SaintDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install SaintDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant SaintDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant SaintDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow SaintDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [SaintDesk Input] service."),
        ...
        ("doc_mac_permission", "https://codesaint.in/remote-support/macos-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next SaintDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant SaintDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant SaintDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running SaintDesk."),
        ...
        ("View Mode", "View mode"),
        ("verify_rustdesk_password_tip", "Verify SaintDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use SaintDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade SaintDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://codesaint.in/remote-support/linux-x11"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent SaintDesk from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if SaintDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep SaintDesk background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the SaintDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, SaintDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, SaintDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, SaintDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: SaintDesk server OSS doesn't include this feature."),
