...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto SaintDesk..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali SaintDesk sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al SaintDesk."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al SaintDesk."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al SaintDesk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [SaintDesk Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep RustDesk background service", "Tenu SaintDesk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de SaintDesk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show RustDesk", "Montri SaintDesk"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al SaintDesk permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al SaintDesk permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta SaintDesk."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli SaintDesk-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi SaintDesk kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi SaintDesk Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi SaintDesk funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de SaintDesk estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de SaintDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la SaintDesk-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, SaintDesk kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, SaintDesk retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, SaintDesk ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: SaintDesk-servilo OSS ne inkluzivas ĉi tiun funkcion."),
