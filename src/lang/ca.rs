...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de SaintDesk..."),
        ...
        ("install_tip", "En alguns casos és possible que el SaintDesk no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el SaintDesk al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al SaintDesk els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al SaintDesk els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al SaintDesk l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «SaintDesk Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manté el servei del SaintDesk en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del SaintDesk, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show RustDesk", "Mostra el SaintDesk"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al SaintDesk els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al SaintDesk els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del SaintDesk en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del SaintDesk"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del SaintDesk, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el SaintDesk Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el SaintDesk funcioni correctament com a equip controlable."),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del SaintDesk està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del SaintDesk en rerefons"),
        ...
        ("About RustDesk", "Quant al SaintDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Actualitzeu el client SaintDesk a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el SaintDesk verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el SaintDesk ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el SaintDesk ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El SaintDesk Server OSS no inclou aquesta característica."),
